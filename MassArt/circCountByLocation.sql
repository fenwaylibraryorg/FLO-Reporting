--metadb:function circCountByLocation

DROP FUNCTION IF EXISTS circCountByLocation;

CREATE FUNCTION circCountByLocation(
...
where io.note_type_name = 'Voyager Historical Charges' and ie.effective_location_name = shelving_location
group by it.title, ic2.contributor_name, ip2.publisher, ip2.date_of_publication, it2.effective_shelving_order, ie.effective_call_number, ie.effective_location_name, io.note
