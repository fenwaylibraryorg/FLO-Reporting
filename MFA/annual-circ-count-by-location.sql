...
and (jsonb_extract_path_text(lt.jsonb, 'metadata', 'updatedDate' ) :: timestamp >= CONCAT(start_date, '0:00:00+00')
and jsonb_extract_path_text(lt.jsonb, 'metadata', 'updatedDate' ) :: timestamp <= CONCAT(end_date, '0:00:00+00'))
