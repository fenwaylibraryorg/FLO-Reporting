--metadb:function inHouseBoston

DROP FUNCTION IF EXISTS inHouseBoston;

CREATE FUNCTION inHouseBoston(    
...
where
	...
	and lt3.name in ('Albert Alphin Library', 'Stan Getz Library')
